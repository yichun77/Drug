...
df, meta = pyreadstat.read_sas7bdat(r"C:\Users\adayc\Desktop\code\Drug\DA_data\diabetes2.sas7bdat")
print(df.head())  
print(meta.column_names)  
print(meta.column_labels)  

# original data
dftxt = pd.read_csv(r"C:\Users\adayc\Desktop\code\Drug\DA_data\diabetesrwrite1.txt", sep="\s+")
